...
$stats_type = array(
	...
	"player" => array(
		...
		"monument_points" => array("id" => 26,
			"name" => totranslate("Points from monuments"),
			"type" => "int"),
		"war_points" => array("id" => 27,
			"name" => totranslate("Points from wars"),
			"type" => "int"),
		"revolt_points" => array("id" => 28,
			"name" => totranslate("Points from revolts"),
			"type" => "int"),
	),
