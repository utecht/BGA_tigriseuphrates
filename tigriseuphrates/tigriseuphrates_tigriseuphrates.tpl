...
var jstpl_points='<div class="points" id="points_${player_id}"><div class="point red_point"></div><span>${red}</span><div class="point black_point"></div><span>${black}</span><div class="point green_point"></div><span>${green}</span><div class="point blue_point"></div><span>${blue}</span><div class="point treasure_point"></div><span>${treasure}</span></div>';

var jstpl_point='<div class="point ${color}_point"></div>';

var jstpl_my_side='<div id="my_side_bar"></div>';
var jstpl_toggle_kingdoms='<button class="toggle_button" id="toggle_kingdoms">Toggle Kingdoms</button>'; var jstpl_force_resize='<div id="size_buttons"><button class="toggle_button" id="size_decrease">-</button><button class="toggle_button" id="force_resize">Reset Board Size</button><button class="toggle_button" id="size_increase">+</button></div>';
