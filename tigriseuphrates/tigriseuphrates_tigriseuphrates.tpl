...
var jstpl_points='<div class="points" id="points_${player_id}"><div id="red_point_target" class="point red_point"></div><span>${red}</span><div id="black_point_target" class="point black_point"></div><span>${black}</span><div id="green_point_target" class="point green_point"></div><span>${green}</span><div id="blue_point_target" class="point blue_point"></div><span>${blue}</span><div id="treasure_point_target" class="point treasure_point"></div><span>${treasure}</span></div>';
