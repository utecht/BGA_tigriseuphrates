...
var jstpl_leader='<div class="leader_token board_leader_${color}" id="leader_${id}" data-x="${x}" data-y="${y}" style="position:absolute; left: ${left}px; top: ${top}px"><div class="leader leader_${shape} leader_${color}"></div><span id="leader_${id}_strength" class="leader_strength leader_strength_${color}">0</span></div>';
var jstpl_leader_hand='<div class="mini_leader_token hand_leader_${color}" id="leader_${id}"><div class="mini_leader mini_leader_${shape} mini_leader_${color}"></div></div>';
...
var jstpl_bag='<div class="player-board" id="bag_progress"><h4 style="text-align:center;margin-top:5px">Treasures Remaining</h4><div style="display:flex;justify-content:center"><h5 style="font-weight:500;margin-right:1em" id="tae_treasures_remain">8</h5><div class="point treasure_point"></div></div><h4 style="text-align:center;margin-top:5px">Tiles Remaining</h4><div id="tae_progress_back"><span id="tae_progress_percent">100%</span><div id="tae_progress_bar"></div></div></div>';

var jstpl_conflict_status='<div id="conflict_status" class="conflict_status whiteblock"><h1 style="font-weight: bold; align-self: center">${conflict_type}</h1><div class="conflict_sides"><div id="conflict_attacker" class="side conflict_attacker"><div class="side_name"><h4>Attacker</h4><h4 style="order:-1" id="attacker_strength"></h4><div class="mini_leader_token"><div class="mini_leader mini_leader_${attacker_color} mini_leader_${attacker_shape}"></div></div></div><div><h4>Board Strength</h4><div id="attacker_board_support" class="board_support"></div></div><div><h4>Support</h4><div id="attacker_hand_support" class="hand_support"></div></div></div><div id="conflict_defender" class="side conflict_defender"><div class="side_name"><h4 style="order:-5">Defender</h4><h4 style="order:-3" id="defender_strength"></h4><div class="mini_leader_token"><div class="mini_leader mini_leader_${defender_color} mini_leader_${defender_shape}"></div></div></div><div class="defender"><h4>Board Strength</h4><div id="defender_board_support" class="board_support"></div></div><div class="defender"><h4>Support</h4><div id="defender_hand_support" class="hand_support"></div></div></div></div></div>';
