...
var jstpl_leader='<div class="leader_token board_leader_${color}" id="leader_${id}" data-x="${x}" data-y="${y}" style="position:absolute; left: ${left}px; top: ${top}px"><div class="leader leader_${shape} leader_${color}"></div><span id="leader_${id}_strength" class="leader_strength">0</span></div>';
